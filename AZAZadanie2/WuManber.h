...
public:
	...
	vector<char>* Search(size_t TextLength, const char *Text, const vector<const char *> &patterns, map<const char*, char> keywords);
protected:
	...
	vector<vector<structPatternMap>> m_vPatternMap;
